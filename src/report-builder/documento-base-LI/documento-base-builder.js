...
const { buildLI } = require("./build-li.js");
...
module.exports = {
  buildDocumentoBase: async ({
   ...
   // === Logo Cliente ===
    ...
    const resultadoLI = await buildLI(empresa, servicoId, gesIds, cliente)
          ...
          body: [
            [
                  ...
                  },
              {
                ...
                text: "LAUDO TÉCNICO DE INSALUBRIDADE",
                bold: true,
                alignment: "center",
                fontSize: 12,
              },
    ...
    return { docDefinitions, resultadoLI };
  },
};
