...
module.exports = {
    buildDocBasePgrtr: async (empresa, servicoId, cliente) => {
        try {
            ...
            const processo = servicoData.dataValues.memorial_descritivo_processo_pgrtr;

            const dataDadosEstatisticos = await getDataDadosEstatisticosByOneLaudoType(empresa.dataValues.id, servicoId, "pgrtr");
...
`
                ...
                },
                {
                    text: [
                        ...
                        `\t\t\tA Secretaria de Inspeção do Trabalho, através da Portaria SEPRT 22.677, de 22/10/2020, publicou a nova redação da Norma Regulamentadora NR-31. O objetivo principal foi estabelecer as diretrizes e os requisitos para o gerenciamento de riscos ocupacionais e as medidas de prevenção em Segurança e Saúde no Trabalho - SST.`                    ],
                    fontSize: 10,
                    bold: false,
                },
                {
                ...
                },
                {
                    text: [
                        ...
                        `\t\t\tEm resumo, o Programa de Gerenciamento de Riscos, de acordo com a Norma Regulamentadora NR31, constitui-se numa ferramenta de extrema importância para a segurança e saúde dos empregados, proporcionando identificar os perigos, as medidas de proteção ao trabalhador a serem implementadas. E para finalizar, devem estar integrados com planos, programas e outros documentos previstos na legislação de segurança e saúde no trabalho
                    `
                    ],
                    fontSize: 10,
                    bold: false,
...
f) acompanhar, monitorando o controle dos riscos ocupacionais.
                ...
                },
                {
                    text: [
                        ...
                        `\t\t\tEste programa foi implementado e desenvolvido em apenas 01 (um) P.G.R.T.R, abrangendo a área agrícola conforme solicitação da organização
                    `,
                    ],
                    fontSize: 10,
                    bold: false,
                ...
                },
                {
                    text: [
                        ...
                        `\t\t\tA estrutura do Programa de Gerenciamento de Riscos no Trabalho Rural – PGRTR, de acordo com a NR-31, baseia-se, no mínimo, no inventário de riscos e no plano de ação.
                    `,
                    ],
                    fontSize: 10,
                    bold: false,
...
c) descrição de perigos e de possíveis lesões ou agravos à saúde dos trabalhadores, com a identificação das fontes ou circunstâncias, descrição de riscos gerados pelos perigos, com a indicação dos grupos de trabalhadores sujeitos a esses riscos, e descrição de medidas de prevenção implementadas;
                ...
                },
                {
                    text: [
                        ...
                        `\t\t\tNo plano de emergência da empresa são indicados possível cenários de acidentes, conforme riscos identificados no PGRTR, bem como as medidas a serem introduzidas, aprimoradas ou mantidas, conforme o nível da emergência.` ],
                    fontSize: 10,
                    bold: false,
                },
                {
